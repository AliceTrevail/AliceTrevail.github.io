...
-   To understand the causes and consequences of seabird connectivity across the Western Indian Ocean. In particular:

    -   Incidence and drivers of seabird prospecting
    
    -   At-sea foraging habitat suitability
    
    -   Status of gene-flow among seabird colonies in the CA and WIO
...
-   Environmental heterogeneity:
    ...
    -   Provides foraging opportunities: spatial response to temporal cycle was amplified

    -   Creates competition among individuals at resource patches, with negative consequences for reproductive success

    -   Promotes individual specialisation in habitat selection

-   Contributed to studies of Antarctic seabird foraging ecology:

    -   South polar skuas, *Catharacta maccormicki*, foraged in areas of low Antarctic petrel, *Thalassoica antarctica*, density during chick rearing, presumably because of successful chick group defense strategies 
    
    -   Individual consistency in foraging behaviour and space use of Antarctic petrels was linked to diet
