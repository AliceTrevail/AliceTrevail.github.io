...
I am always keen to collaborate on projects maximising existing seabird tracking data. Tracking data that I have collected can be requested through the Seabird Tracking Database:
...
STDB_data <- read_csv("data/STDB_datasets.csv") %>%
  mutate(URL = paste0("<a href = ", Link, "> ", Species, ", ", Colony, ", ", Year, "</a>"))
